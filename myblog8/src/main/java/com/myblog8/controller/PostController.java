...
public class PostController {
    ...
    public ResponseEntity<PostDto> getPostByPostId(@PathVariable int postId){
        ...
        return new ResponseEntity<>(dto,HttpStatus.OK);
            ...
            @GetMapping  //http://localhost:8080/api/posts?pageNo=0
            // http://localhost:8080/api/posts?pageNo=2&pageSize=3&sortBy=title
            //// http://localhost:8080/api/posts?pageNo=2&pageSize=3&sortDir=desc
            //http://localhost:8080/api/posts?pageNo=2&pageSize=3&sortBy=content&sortDir=desc
            //ternary operataior = it is repalce a if else statement
               public PostResponse getAllPosts(
                    ...
                    @RequestParam(value="soryDir",defaultValue="asc",required=false)String sortDir
